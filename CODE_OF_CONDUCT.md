...
*[Português](CODE_OF_CONDUCT.pt-BR.md) · [Español](CODE_OF_CONDUCT.es.md)*
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers by opening a private security advisory or contacting them directly (see [SECURITY.md](SECURITY.md) for contact guidance). All complaints will be reviewed and investigated promptly and fairly.
